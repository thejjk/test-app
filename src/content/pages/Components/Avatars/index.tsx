            ...
            <Card>
              ...
              <CardContent>
                <Stack direction="row" spacing={2}>
                  <Avatar alt="Remy Sharp" src="src/assets/static/images/avatars/1.jpg" />
                  <Avatar
                    alt="Travis Howard"
                    src="src/assets/static/images/avatars/2.jpg"
                  />
                  <Avatar
                    alt="Cindy Baker"
                    src="src/assets/static/images/avatars/3.jpg"
                  />
                </Stack>
              </CardContent>
            </Card>
            ...
            <Card>
              ...
              <CardContent>
                <Stack direction="row" spacing={2}>
                  <Avatar
                    alt="Remy Sharp"
                    src="src/assets/static/images/avatars/4.jpg"
                    sx={{ width: 24, height: 24 }}
                  />
                  <Avatar alt="Remy Sharp" src="src/assets/static/images/avatars/5.jpg" />
                  <Avatar
                    alt="Remy Sharp"
                    src="src/assets/static/images/avatars/3.jpg"
